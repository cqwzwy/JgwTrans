...
public class Test2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("ids", "csssa");
		
		//response.sendRedirect(request.getContextPath()+"/test");
		/*
		 * String rn=request.getServerName(); pw.println("ts\n serverName: "+rn
		 ...
		 * System.out.println("Test2/dis"+request.getServletPath()+"/1.txt");
		 */
		request.setAttribute("id", "xww");
		
		RequestDispatcher dispatcher=request.getRequestDispatcher("/TestData");
		//response.sendRedirect("");
		//dispatcher.forward(request, response);
		//dispatcher.include(request, response);
		pw.println("hhhhhhh");
		System.out.println("Test2ad/dis"+request.getServletPath()+"/1.txt");
	}
